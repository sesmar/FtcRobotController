...
@Autonomous(name="Calamari: Autonomous Drive A2F2", group="Calamari", preselectTeleOp = "Calamari: TeleOpMode")
public class CalamariAutonomousOpModeA2F2 extends LinearOpMode {
