...
public class AutonomousProgramRed implements IAutonomousProgram{
	...
	public AutonomousProgramRed(CalamariRobot robot, StartingBlock startingBlock){
		if (startingBlock == StartingBlock.A2 || startingBlock == StartingBlock.F2) {
			steps.add(new AutonomousStepDriveToSpikeMarkA2F2(robot, AllianceColor.RED, robot.myEyes.getSpikeMark()));
		}else{
			steps.add(new AutonomousStepDriveToSpikeMarkA4F4(robot, AllianceColor.RED, robot.myEyes.getSpikeMark()));
		}
		...
		if (startingBlock == StartingBlock.A2 || startingBlock == StartingBlock.F2) {
			steps.add(new AutonomousStepPrepForParkA2F2(robot, AllianceColor.RED, robot.myEyes.getSpikeMark()));
			...
			steps.add(new AutonomousStepPrepForParkA4F4(robot, AllianceColor.RED, robot.myEyes.getSpikeMark()));
